...
import 'pallete.dart';
class garbageInterntComplainScreen extends StatefulWidget {
  String value;
  garbageInterntComplainScreen({this.value});
  @override
  _garbageInterntComplainScreenState createState() => _garbageInterntComplainScreenState(value);
}
class _garbageInterntComplainScreenState extends State<garbageInterntComplainScreen> {
  String value;
  String company;
  String cIssue;
  _garbageInterntComplainScreenState(this.value);
